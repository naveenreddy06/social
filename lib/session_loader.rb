module SessionLoader
  ...
  def session_friends
    ...
    session[:all_ids]=session[:myfds].to_a + session[:usr_self].to_a 
  end
  ...
  def session_circles
    ...
    session[:all_circles]= session[:usr_circles].to_a  + session[:circles].to_a 
  end
  ...
  def session_user_chronicles
    ...
    session[:all_chronicles]=session[:otr_chronicles].to_a  + session[:usr_chronicles].to_a 
  end
  ...
  def session_connections
    ...
    session[:all_connections]=session[:fds_connections].to_a  + session[:usr_connections].to_a 
  end
  ...
  def session_all
     session[:all_ids].to_a + session[:all_ids].to_a+session[:all_circles].to_a+session[:following].to_a+session[:all_chronicles].to_a+session[:all_connections].to_a
  end
